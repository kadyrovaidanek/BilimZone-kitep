    ...
    return (
        <main className="min-h-screen bg-slate-50 px-4 py-6 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl space-y-5">
                ...
                {!isLoading && data && (
                    <>
                        <ReportSummaryCards role="admin" data={data} />
                        <ReportCharts role="admin" data={data} />
                        <ReportTables role="admin" data={data} />
                    </>
                )}
            </div>
        </main>
